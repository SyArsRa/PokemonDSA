...
public:  
    ...
    void parser(string FILENAME,Hashmap<Type>* data)
    {
        ...
        while (getline(fin,row))
        {
            ...
            transform(content[0].begin(), content[0].end(), content[0].begin(), ::toupper);                transform(content[1].begin(), content[1].end(), content[1].begin(), ::toupper);
    ...
    //Parses Pokemon.csv into a hashmap for Pokemon
